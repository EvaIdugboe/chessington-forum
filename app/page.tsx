...
import { EVENT_DETAILS } from "./config/form";
              ...
              <div className="rounded-3xl bg-emerald-800 p-6 text-white shadow-sm">
                ...
                <div className="mt-5 space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-2xl font-semibold">{EVENT_DETAILS.time}</p>
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-[0.2em] text-emerald-200">Date</p>
                    <p className="mt-1 text-2xl font-semibold">{EVENT_DETAILS.date}</p>
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-[0.2em] text-emerald-200">Location</p>
                    <p className="mt-1 text-2xl font-semibold leading-snug">{EVENT_DETAILS.location}</p>
                  </div>
                </div>
              </div>
